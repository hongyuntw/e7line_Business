    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            <div class="container">
                ...
                <form enctype="multipart/form-data" class="well form-horizontal" action="{{ route('admin_announcement.update',$announcement->id) }}" method="post">
                    @csrf
                    ...
                    <fieldset>
                            ...
                            <div class="inputGroupContainer">
                                <div class="input-group">
                                    ...
                                    <select name="type" class="form-control">
                                        <option value="0" @if($announcement->type == 0) selected @endif>通知</option>
                                        <option value="1" @if($announcement->type == 1) selected @endif>活動</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="hidden" name="source_html" value="{{$source_html}}">
